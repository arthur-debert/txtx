 ...
 */
function registerEmoticonFeature(context, outputChannel) {
 ...
 * @param {vscode.OutputChannel} outputChannel
 */
async function handleEmoticonSearch(editor, outputChannel) {
 ...
 * @param {vscode.OutputChannel} outputChannel
 */
async function replaceEmoticonSearch(editor, range, emoticon, outputChannel) {
