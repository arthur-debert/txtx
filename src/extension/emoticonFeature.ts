 ...
 */
function registerEmoticonFeature(context: vscode.ExtensionContext, outputChannel: vscode.OutputChannel): void {
 ...
 * @param outputChannel - The output channel
 */
async function handleEmoticonSearch(editor: vscode.TextEditor, outputChannel: vscode.OutputChannel): Promise<void> {
