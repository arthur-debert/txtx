 ...
 */
function generateHtmlAndCss(lines: string[], baseName: string): { htmlContent: string, cssContent: string } {
 ...
 */
function registerExportCommands(context: vscode.ExtensionContext, outputChannel: vscode.OutputChannel): void {
