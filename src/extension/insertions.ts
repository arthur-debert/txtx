 ...
 */
function registerInsertions(context: vscode.ExtensionContext, outputChannel: vscode.OutputChannel): void {
 ...
 * @param outputChannel - The output channel
 */
async function handleInsertionSearch(editor: vscode.TextEditor, outputChannel: vscode.OutputChannel): Promise<void> {
