 ...
 */
class txxtDocumentSymbolProvider implements vscode.DocumentSymbolProvider {
  ...
  findParentSymbol(
    ...
    for (const symbol of symbols) {
      if (symbol.range.contains(position) && symbol.kind === vscode.SymbolKind.File) {
        return symbol;
      }
    }
    return null;
...
export default txxtDocumentSymbolProvider;
