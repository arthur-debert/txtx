...
function registerFormatCommands(context: vscode.ExtensionContext, outputChannel: vscode.OutputChannel): void {
    ...
    const generateTOCCommand = vscodeLib.registerCommand(context, 'rfcdoc.generateTOC', formatCommands.generateTOC, outputChannel);
    
    const fullFormattingCommand = vscodeLib.registerCommand(context, 'rfcdoc.fullFormatting', formatCommands.fullFormatting, outputChannel);
