 ...
 * @param {vscode.TextDocument} document - The document to fix numbering in
 * @returns {Promise<boolean>} - Whether the numbering fix was successful
 */
async function fixNumbering(document) {
 ...
 * @param {string[]} lines - The lines to fix numbering in
 * @returns {string[]} - The lines with fixed numbering
 */
function fixNumberingInLines(lines) {
 ...
 */
function registerNumberingCommands(context, outputChannel) {
