 ...
 * @param {vscode.TextDocument} document - The document to export
 * @returns {Promise<boolean>} - Whether the export was successful
 */
async function exportAsHtml(document) {
 ...
 * @returns {Object} - Object containing HTML and CSS content
 */
function generateHtmlAndCss(lines, baseName) {
...
function generateCss() {
    try {
        ...
        const templatePath = path.join(__dirname, 'templates', 'rfcdoc-html.css');
 ...
 */
function generateHtml(lines, baseName) {
 ...
 * @returns {string} - The processed text with HTML formatting
 */
 ...
 * @param {string} line - The line to check
 * @returns {boolean} - Whether the line is a numbered section header
 */
 ...
 * @param {string} line - The line to check
 * @returns {boolean} - Whether the line is an uppercase section header
 */
function isUppercaseSection(line) {
 ...
 * @param {string} line - The line to check
 * @returns {boolean} - Whether the line is an alternative section header
 */
function isAlternativeSection(line) {
 ...
 */
function processDocumentReferences(text) {
 ...
 */
function registerExportCommands(context, outputChannel) {
